...
def fluorescence_spectra(fluxes,raw_lines,raw_levs,ritz_col,lower_col,upper_col,aval_col,renorm=True):  
    ...
    #We want the smallest eigenvector with ALL positive eigenvalues or ALL negative values
    ...
    print('Selecting Correct Eigenvector...')
    ...
    return(pops,intens,eigenvalues,eigenvectors)
#%%
