...
Sample File showing some of the time-dependent functionality of FlorPy using CO+
...
plt.savefig('Sample CO+ stick spectrum.pdf',dpi=200)
...
plt.legend()
plt.title('CO+ Fluorescence Spectrum with approximate errorbars based on {:} iterations'.format(number_of_err_iterations), fontsize=15)
plt.xlim(300,700)
plt.grid(True)
plt.ylabel(r'G-factor ($10^{-21}$ J/s/mol)',fontsize=15)
plt.xlabel('Wavelength (air nm)', fontsize=15)
plt.savefig('sample_co+_errorbar_plot.pdf', dpi=200)
