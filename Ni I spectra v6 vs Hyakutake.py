...
"""
SJB
script for running fluorescence model and plotting synthetic spectra versus spectra from comet Hyakutake
01-13-2021
"""
...
#%%
#Normalize hyakutake spectra maximum intensity to 1 for viewing convenience:
...
plt.plot(hyak0[:,0]/10,hyak0[:,1], label = 'Hyakutake 0 Offset')
plt.legend()
plt.grid(True)
plt.xlim(100,500)
#Save a figure + datafile 
plt.savefig('{:}_vs_Hyakutake_scaled_spectra.pdf'.format(species_string))
