...
#%%
#If desired, the user can compute the possible uncertainty in the gfactors by Monte-Carloing them. Note: for CO+,
#all lines have an 'A' rating as a placeholder.

flor = error_iterations(flor,element_string,orbit_id, bbsupp=False, bbtemp = 5777, lower_cutoff = 1e30, upper_cutoff=1e30, aval_min = 0, permit_cascade=True, rad_choice = 'user', profiles = 'doppler', err_id = 'default_setting', num_iterations=100,process=True)
#%%
