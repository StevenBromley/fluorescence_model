...
#%%
flor = generate_fluxes_general(flor, element_string, orbit_id, rad_choice = 'user', profiles='doppler', bbsupp=False, lower_cutoff = 1e30, upper_cutoff=1e30, aval_min=0)
...
#                                                   #
#####################################################
flor = error_iterations(flor,element_string,orbit_id,err_id = 'err10', num_iterations=10,profiles='doppler',rad_choice='user')
flor = error_iterations(flor,element_string,orbit_id,err_id = 'err100', num_iterations=100,profiles='doppler',rad_choice='user')
flor = error_iterations(flor,element_string,orbit_id,err_id = 'err1k', num_iterations=1000,profiles='doppler',rad_choice='user')
