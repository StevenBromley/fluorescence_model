...
def generate_fluxes_general(flor,element_string,orbit_id,rad_choice='default', bbsupp=True, bbtemp = 5777, profiles='delta', lower_cutoff = 1e30, upper_cutoff=1e30, aval_min = 0, bbflux_min=0, permit_cascade=True):
    """
    SJB
    06-12-2021
...
def generate_rad_grid(rad, wavelengths):
    ...
    return(output_arr)
#%%
def error_iterations(flor,element_string,orbit_id, bbsupp=True, bbtemp = 5777, lower_cutoff = 1e30, upper_cutoff=1e30, aval_min = 0, rad_choice = 'default', profiles = 'doppler', err_id = 'default_setting', num_iterations=100,process=True,bbflux_min=0,permit_cascade=True):
    """
    08-10-2021
    SJB
    ...
    flor = generate_fluxes_general(flor, element_string, orbit_id, rad_choice = rad_choice, profiles=profiles, bbtemp=bbtemp, bbsupp=bbsupp,lower_cutoff=lower_cutoff,upper_cutoff=upper_cutoff,aval_min=aval_min,permit_cascade=permit_cascade,bbflux_min=bbflux_min)
